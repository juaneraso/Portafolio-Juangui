  ...
  return (
    <div className={style.container}>
      <div className={style.card}>
        ...
        <div className={style.container}>
          <Link
            to="https://vite-pokemon-two.vercel.app/"
            target="_blank"
          ...
          <Link
            to="https://github.com/juaneraso/POKEMONPROYECTO"
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      <div className={style.card}>
        ...
        <div className={style.container}>
          <Link
            to="https://rick-and-morty-front-ivory.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className={style.centeredButton}>Deploy</button>
          ...
          <Link
            to="https://github.com/juaneraso/rick_and_morty_mine"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className={style.centeredButton}>GitHub</button>
      ...
      <div className={style.card}>
        ...
        <div className={style.container}>
          <Link
            to="https://espacio-flipante-pf.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className={style.centeredButton}>Deploy</button>
          ...
          <Link
            to="https://github.com/juaneraso/PF_FRONT_ESPACIO_FLIPANTE"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className={style.centeredButton}>GitHub</button>
      ...
      <div className={style.card}>
        ...
        <div className={style.container}>
          <Link
            to="https://frontend-juangui.vercel.app/home"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className={style.centeredButton}>Deploy</button>
          ...
          <Link
            to="https://github.com/juaneraso/Backend-Juangui"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className={style.centeredButton}>GitHub</button>
